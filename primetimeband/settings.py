"""
Django settings for primetimeband project.
...
ROOT_URLCONF = 'primetimeband.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.full_url_name',
...
WSGI_APPLICATION = 'primetimeband.wsgi.application'
